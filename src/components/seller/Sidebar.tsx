    ...
    <div className="seller-sidebar">
      <div className="review-card">
        <div className="reviewer">
          ...
          <p>
          Farm-RAMIP<span>Platform</span>
          </p>
        </div>
      </div>
      <div className="delivery-info">
        <h1>
          Unlock New Opportunities with Farm-RAMIP: The Ultimate
          Marketplace for Growing Your Business!
        </h1>
        <p>
          Join a thriving community of sellers on Farm-RAMIP and tap
          ...
          revenue, or connect with more customers, Farm-RAMIP is the
