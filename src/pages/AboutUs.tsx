...
export const AboutUs = () => {
  ...
  return (
    <>
      <Meta title="About us - Farm-RAMIP" />
      <div className="about">
        <div className="about__container">
          <h1>About Farm-RAMIP PlatforM </h1>
          <section className="welcome">
            <h2>Empowering Farmers, Connecting Markets</h2>
            <div className="paragraph">
              <p>
                <b>Farm-RAMIP Platform </b> is a digital platform designed to
          ...
          <section className="works">
            ...
            <div className="works__list">
              ...
              <div className="works__item">
                ...
                <p>
                  The Farm-RAMIP Team arranges the delivery of the produce to the wholesalers.
                </p>
              </div>
            </div>
          </section>
